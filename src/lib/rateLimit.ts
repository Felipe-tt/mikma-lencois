...
// separados, reduz busca no Secret Manager por cold start. As vars antigas
// (UPSTASH_REDIS_REST_URL/TOKEN) foram apagadas do Secret Manager, nao
// existe mais fallback pra elas.
function upstashCreds(): { url?: string; token?: string } {
  ...
  try {
    ...
    console.error('UPSTASH_REDIS_CREDS: JSON invalido');
    return {};
  }
}
