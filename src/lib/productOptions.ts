...
export const SIZES = ['solteiro', 'casal', 'queen', 'king', 'berco'] as const;
export type Size = typeof SIZES[number];

export const SIZE_LABEL: Record<string, string> = { solteiro: 'Solteiro', casal: 'Casal', queen: 'Queen', king: 'King', berco: 'Berço' };
