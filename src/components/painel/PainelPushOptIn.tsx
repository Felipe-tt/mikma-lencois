...
export function PainelPushOptIn() {
  ...
  return (
    <div data-no-print className="mb-5 flex flex-col sm:flex-row sm:items-center gap-3 justify-between px-4 py-3.5 bg-white dark:bg-warm border border-mist rounded-xl">
      ...
      <div className="flex items-center gap-2 shrink-0 self-end sm:self-auto">
        <button
          ...
          className="text-[12px] text-faint px-3 py-2 hover:text-mid"
        >
          Agora não
        </button>
        <button
          ...
          className="text-[12px] font-semibold text-paper bg-clay-l px-4 py-2 rounded-sm disabled:opacity-60"
        >
