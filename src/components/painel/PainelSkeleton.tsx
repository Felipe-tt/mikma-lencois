  ...
  return (
    <div className="flex flex-col gap-5 animate-pulse">
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="border border-mist p-4 flex items-center gap-4 rounded-xl">
  ...
  return (
    <div className="flex flex-col gap-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[1,2,3,4].map(i => (
          <div key={i} className="border border-mist p-5 rounded-xl">
...
export function PainelFormSkeleton() {
  return (
    <div className="flex flex-col gap-5 animate-pulse max-w-2xl">
      ...
      {[1,2,3].map(i => (
        <div key={i} className="border border-mist p-5 flex flex-col gap-4 rounded-xl">
