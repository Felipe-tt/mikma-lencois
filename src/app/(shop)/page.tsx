        ...
        <div className="container-shop">
          <div className="grid lg:grid-cols-2 min-h-[580px]">
            ...
            <div className="flex flex-col justify-center py-20 lg:py-28 lg:pr-16">
              ...
              <p className="mt-7 text-base text-mid max-w-xs leading-relaxed">{s.heroSubtitle}</p>
            ...
            <div className="hidden lg:flex items-center justify-center border-l border-mist relative overflow-hidden bg-warm">
              <div className="absolute inset-0" style={{
                backgroundImage: `linear-gradient(rgba(28,28,26,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(28,28,26,0.04) 1px, transparent 1px)`,
              ...
              <div className="relative flex flex-col items-center gap-4 z-10">
                <Image src="/logo-white.png" alt={s.storeName} width={220} height={110} className="w-48 h-auto object-contain" />
                <div className="text-center">
                  <div className="w-8 h-px bg-clay mx-auto"/>
                  <p className="mt-2 text-xs text-mid/60 tracking-wider">{s.storeCity.toUpperCase()}</p>
                </div>
              </div>
