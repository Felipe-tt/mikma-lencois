    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="prose prose-sm text-gray-700 space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-2">2. Cadastro</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-2">3. Pedidos e pagamentos</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-2">4. Entrega</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-2">6. Uso aceitável</h2>
            <p>
