    ...
    <div>
      <div className="page-header">
        <div className="container-shop">
          ...
          <p className="text-sm text-mid mt-2">{user.email}</p>
        </div>
      </div>
      ...
      <div className="container-shop py-8 sm:py-12 pb-20">
          ...
          {LINKS.map(({ href, label, desc, icon }) => (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-mid mt-1 leading-relaxed">{desc}</p>
                <p className="text-xs text-clay mt-3 font-medium inline-flex items-center gap-1 group-hover:gap-2 transition-all">
                  Acessar
        ...
        <button
          onClick={logout}
          className="mt-10 text-sm text-faint hover:text-ink transition-colors inline-flex items-center gap-2"
        >
